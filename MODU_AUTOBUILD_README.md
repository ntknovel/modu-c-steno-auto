...
Keep existing working UF2 files. Flashing is a separate manual step.
Source licenses and third-party notices are inside modu-source.zip.
No Personal Access Token belongs in this repository or in workflow secrets.